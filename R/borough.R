...
#' \describe{
#'  \item{ \code{ elevation }}{ \code{ integer }. Elevation of the Sun in degrees } \item{ \code{ variation_am }}{ \code{ numeric }. Difference between the shadow of the Sun before noon and the compass north. } \item{ \code{ variation_pm }}{ \code{ numeric }. Difference between the shadow of the Sun after noon and the compass north. } \item{ \code{ variation_north }}{ \code{ numeric }. Variation between true and magnetic north. }
#' }
#' @format
#' A data frame with 4 columns and 9 rows:
#' \describe{
