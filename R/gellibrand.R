...
#' \describe{
#'  \item{ \code{ afternoon }}{ \code{ logical }. Reading was taken in the afternoon } \item{ \code{ altitude }}{ \code{ numeric }. Altitude of the Sun in degreees } \item{ \code{ azim_mag }}{ \code{ numeric }. Magnetic azimuth in degrees } \item{ \code{ azim_sun }}{ \code{ numeric }. Azimuth of the Sun in degrees } \item{ \code{ variation }}{ \code{ numeric }. Variation between true and magnetic north in degrees }
#' }
#' @format
#' A data frame with 5 columns and 11 rows:
#' \describe{
