...
#' \describe{
#'  \item{ \code{ year }}{ \code{ integer }. Year } \item{ \code{ price }}{ \code{ integer }. Price in rupees per 1,000 seers of wheat in Delhi } \item{ \code{ maximum }}{ \code{ logical }. Indicator marking a price maxima in a cycle } \item{ \code{ crisis }}{ \code{ logical }. Commercial crisis }
#' }
#' @format
#' A data frame with 4 columns and 74 rows:
#' \describe{
...
#' 
#' @source
#' Jevons, W. Stanley. 1879. "Sun-Spots and Commercial Crises." \emph{Nature}. \href{https://dx.doi.org/10.1038/019588a0}{doi:10.1038/019588a0}.
