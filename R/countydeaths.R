...
#' \describe{
#'  \item{ \code{ county }}{ \code{ character }. County name } \item{ \code{ year }}{ \code{ integer }. Year } \item{ \code{ death_rate }}{ \code{ numeric }. Annual deaths per thousand in that county }
#' }
#' @format
#' A data frame with 3 columns and 48 rows:
#' \describe{
